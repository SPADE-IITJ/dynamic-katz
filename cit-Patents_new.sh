...
graph_file="Graphs/cit-Patents_new.txt"  # Replace with your graph file name
update_files=(
    "Graphs/cit-Patents_new_16_del.txt" "Graphs/cit-Patents_new_16_add.txt"  # Pair 1
    "Graphs/cit-Patents_new_165_del.txt" "Graphs/cit-Patents_new_165_add.txt"  # Pair 2
    "Graphs/cit-Patents_new_1652_del.txt" "Graphs/cit-Patents_new_1652_add.txt"
    "Graphs/cit-Patents_new_16519_del.txt" "Graphs/cit-Patents_new_16519_add.txt"
    "Graphs/cit-Patents_new_165189_del.txt" "Graphs/cit-Patents_new_165189_add.txt"
)
